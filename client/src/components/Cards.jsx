...
const Cards = () => {
    const cards = [
        ...
        },
        {
            ...
            description: "PKVY aims is to produce agricultural products free from chemicals and pesticides residues by adopting eco- friendly, low- cost technologies and supporting organic farming.",
