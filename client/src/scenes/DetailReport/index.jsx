...
const DetailReport = () => {
    ...
    return (
        <>
            <div style={{padding: "30px", boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.2)', margin: "30px", borderRadius: "10px", border: "2px solid rgba(54, 162, 235, 1)"}}>
            <center><h3>Cultivated land over the years (in hectares)</h3></center>
            <FirstGraph stateName={stateName} />
            </div>
            <div style={{padding: "30px", boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.2)', margin: "30px", borderRadius: "10px", border: "2px solid rgba(72,191,132,1)"}}>
            <center><h3>Total production over the years (in tonnes)</h3></center>
            <SecondGraph stateName={stateName} />
            </div>
            <div style={{padding: "30px", boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.2)', margin: "30px", borderRadius: "10px", border: "2px solid rgba(255,205,86,1)"}}>
            <center><h3>Different Crops produced</h3></center>
            <ThirdGraph stateName={stateName} />
            </div>
            <div style={{padding: "30px", boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.2)', margin: "30px", borderRadius: "10px", border: "2px solid rgba(255,99,132,1)"}}>
